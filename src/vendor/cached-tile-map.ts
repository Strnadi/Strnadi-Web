// Stolen from https://github.com/yagajs/leaflet-cached-tile-layer
// stolen due to the need to rebundle it in order to make it not use the full leaflet
// source code, weighing a lot
