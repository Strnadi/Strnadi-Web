...
import Back from '@/icons/icon-back.svg';
...
import Notification from '@/features/Notifications/components/Notification.vue';
import { notificationStore } from '@/features/Notifications/state/NotificationStore';
      ...
      <aside v-if="Component" class="side">
        <div>
          <div class="flex flex-row gap-x-1 items-center mr-2">
            ...
            <button class="small" @click="closePopup">
              <img :src="Close" />
            </button>
          </div>
