  ...
  <div class="flex flex-col items-center gap-y-4 sm:gap-y-6 w-full">
    <div class="flex flex-col sm:flex-row items-center gap-y-3 gap-x-10">
      ...
      <div class="flex flex-col text-center sm:text-left">
        ...
        <a external="true" href="mailto:info@strnadi.cz" class="text-xs sm:text-sm break-all">info@strnadi.cz</a>
        <a external="true" href="mailto:developers@strnadi.cz"
          class="text-xs sm:text-sm break-all">developers@strnadi.cz</a>
      </div>
    </div>
    ...
    <div class="flex flex-col w-full gap-y-2">
      ...
      <RouterLink to="/informace/projekt/nas-tym"
        class="button-secondary text-sm sm:text-base py-3 px-4 w-full text-center touch-manipulation">
