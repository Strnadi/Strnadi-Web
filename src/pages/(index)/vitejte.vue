...
<template>
  <div class="flex flex-col items-center gap-y-6 w-full">
    ...
    <div class="flex flex-col w-full gap-x-1 gap-y-1">
      <PrefetchLink to="/podporuji-nas" class="button-secondary text-lg p-2 w-full text-center">
        Kdo nás podporuje
      </PrefetchLink>
      <PrefetchLink to="/o-nas" class="button-secondary text-lg p-2 w-full text-center">
        O týmu
      </PrefetchLink>
    </div>
    ...
    <h2 class="self-start">Kontakty</h2>
    <div class="flex flex-row gap-x-4">
      <a external="true" href="mailto:info@strnadi.cz">info@strnadi.cz</a>
      <a external="true" href="mailto:developers@strnadi.cz">developers@strnadi.cz</a>
    </div>
